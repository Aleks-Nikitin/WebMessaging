...
function Navbar() {
  ...
  return (
    <div className="app-navbar flex justify-between p-4">
      <div className="app-navbar-brand flex flex-3 justify-end ">
        <Link to="/">
      ...
      {(!user && !isLoading) ? (
        <div className="app-navbar-links links flex flex-2 gap-3 justify-end text-2xl">
          <Link to="/signup">
